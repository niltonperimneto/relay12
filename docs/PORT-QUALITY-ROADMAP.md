...
| D3D12TranslationLayer compiler | Ownership contracts compile under native C++ and MinGW; the dependency probe records the next boundary | Every translation unit compiles with C++17 and warnings as errors |
