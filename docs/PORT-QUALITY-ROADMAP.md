...
| D3D12TranslationLayer source | Pinned blocker inventory with exact files and counts | Prepared inventory reaches zero except explicitly retained public-SDK paths |
| D3D12TranslationLayer compiler | MinGW reaches the documented `atlbase.h` boundary | Every translation unit compiles with C++17 and warnings as errors |
