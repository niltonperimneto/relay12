...
| D3D12TranslationLayer compiler | Ownership contracts pass under native C++ and MinGW/Wine; preprocessing reaches the `d3dkmthk.h` WDK boundary | Every translation unit compiles with C++17 and warnings as errors |
